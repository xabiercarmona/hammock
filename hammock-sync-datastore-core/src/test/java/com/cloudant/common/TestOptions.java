...
public class TestOptions {
    ...
    public static final Boolean SPECIFIED_COUCH = Boolean.valueOf(
            System.getProperty("test.with.specified.couch", Boolean.TRUE.toString()));
     ...
     */
    public static final String COUCH_USERNAME = System.getProperty("test.couch.username", "admin");
     ...
     */
    public static final String COUCH_PASSWORD = System.getProperty("test.couch.password", "password");
     ...
     */
    public static final String COUCH_HOST = System.getProperty("test.couch.host", "10.0.2.2");
