...
public interface Replicator {
     ...
     *
     * <ul>
     *  <li>If you call start when in {@link State#PENDING},
     *   replication will start.</li>
     *  <li>In {@link State#STARTED}, nothing changes.</li>
     *  <li>In {@link State#STOPPING}, nothing changes.</li>
     *  <li>In {@link State#ERROR}, the replication will restart.
     *   It's likely its going to error again, however, depending on whether
     *   the error is transient or not.</li>
     *  <li>In {@link State#STOPPED} or
     *   {@link State#COMPLETE}, the replication will start a
     ...
     * called, the replicator will be in the {@link State#STOPPING}
     * state while operations complete and will move to the
     * {@link State#STOPPED} state when the replicator has fully
     * shutdown.</p>
     *
     * <p>It is also possible the replicator moves to the
     * {@link State#ERROR} state if an error happened during the
     * shutdown process.</p>
     *
     * <p>If the replicator is in the {@link State#PENDING} state,
     * it will immediately move to the {@link State#STOPPED} state.
     * </p>
     */
    void stop();

    /**
     * <p>Returns the {@link State} this replicator is in.</p>
     *
     * <p>{@code getState} may be called from any thread.</p>
     *
     * <p>In all states other than {@link State#STARTED} and
     * {@link State#STOPPING}, the replicator object
     * is idle with no background threads.</p>
     *
     * @return the {@link State} this replicator is in
     */
    State getState();
